...
def main():
    ...
    with input_container:
        ...
        if button3:
            ...
            st.session_state["user_question"] = """Analyze the patient's current situation and write a structured clinical note. Do not provide a generic example note. Include good medical decision making.
        ...
        if button4:
            ...
            st.session_state["user_question"] = """You are an emergency medicine specialist tasked with providing patient education materials. Based on the clinical details provided, generate an easy-to-understand patient education note in the specified language. covering the following:
